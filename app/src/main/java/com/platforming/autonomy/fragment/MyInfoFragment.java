...
public class MyInfoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        et_myinfo_phonenumber.setText(User.user.getTelephone());
        tv_myinfo_email.setText(FirestoreManager.getFirebaseAuth().getCurrentUser().getEmail());
        ibtn_myinfo_profile.setImageResource(User.user.getProfile());
            ...
            public void onClick(View view) {
                ...
                firestoreManager.updateUserData(myInfoData, new ListenerInterface() {
                    ...
                    public void onSuccess() {
                        ...
                        et_myinfo_class.setText(String.format("%c학년 %s반 %s번", studentId.charAt(0), Integer.parseInt(studentId.substring(1, 3)), Integer.parseInt(studentId.substring(3, 5))));
                        User.user.setUsername(et_myinfo_username.getText().toString());
                        User.user.setNickName(et_myinfo_nickname.getText().toString());
                        User.user.setStudentId(studentId);
                        User.user.setTelephone(et_myinfo_phonenumber.getText().toString());
                        User.user.setProfileIndex(Math.toIntExact(profileIndex));
