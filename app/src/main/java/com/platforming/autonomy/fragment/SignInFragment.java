...
public class SignInFragment extends Fragment{
            ...
            public void onClick(View v) {
                ...
                customDialog.passwordResetDialog(getActivity(), new ListenerInterface() {
                    ...
                    public void onSuccess(String msg) {
                        String email = msg;
                        FirestoreManager.getFirebaseAuth().sendPasswordResetEmail(email).addOnCompleteListener(task -> {
    ...
    private void signInWithEmail(String email, String password){
        ...
        FirestoreManager.getFirebaseAuth().signInWithEmailAndPassword(email, password).addOnCompleteListener(task -> {
            if(task.isSuccessful()){
                readData();
            }else{
                CustomDialog customDialog = new CustomDialog();
    ...
    private void signInWithGoogle(GoogleSignInAccount acct){
        ...
        FirestoreManager.getFirebaseAuth().signInWithCredential(credential)
