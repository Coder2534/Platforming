...
import com.platforming.autonomy.adapter.RecyclerViewSliderAdapter;
import com.platforming.autonomy.adapter.TableAdapter;
import com.platforming.autonomy.fragment.SignUpFragment;
    ...
    public void verificationDialog(Activity activity){
        ...
        zontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseUser user = FirestoreManager.getFirebaseAuth().getCurrentUser();
